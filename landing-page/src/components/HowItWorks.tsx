function HowItWorks() {
  return (
    <section id="approach" className="section-space bg-[#09090b]">
      <div className="page-shell">
        <p className="eyebrow">The approach</p>
        <div className="mt-5 grid min-w-0 gap-10 sm:gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.4fr)]">
          <h2 className="type-section max-w-md font-medium text-white">
            ...
            {[
              ...
              <article key={number} className="grid gap-4 py-7 sm:grid-cols-[4rem_1fr] sm:gap-8 sm:py-9">
                ...
                <div>
                  ...
                  <p className="type-body mt-3 max-w-lg text-zinc-300">{description}</p>
                </div>
              </article>
            ))}
          </div>
